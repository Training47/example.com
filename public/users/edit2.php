...
//If id cannot be found, cancel request
if(empty($row)){
...
<div class="form-group">
    ...
    <input id="first_name" value="{$row['first_name']}" name="first name" type="text" class="form-control">
</div>

<div class="form-group">
    <label for="last_name">Last Name</label>
    <input id="last_name" value="{$row['last_name']}"name="last name" type="text" class="form-control">
</div>
